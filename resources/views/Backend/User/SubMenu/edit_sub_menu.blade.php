    ...
    <div class="card">
        ...
        <div class="card-block">
            ...
            @if(Session::get('success'))
                ...
                @if($data)
            <form method="POST" enctype="multipart/form-data" action="{{url('/subMenuUpdate')}}/{{$data->id}}">
                @csrf
                ...
                <div class="input-single-box">
                    ...
                    <select class="form-control" name="main_menuid">
                        ...
                        <option @if($data->main_menuid == $show_mainmenu->id) selected @endif value="{{$show_mainmenu->id}}">{{$show_mainmenu->link_name}}</option>
                        @endforeach
                        @endif
                    </select>
                </div>
                <div class="input-single-box">
                    ...
                    <input type="text" name="submenu_name" class="form-control" value="{{$data->submenu_name}}">
                </div>
                <div class="input-single-box">
